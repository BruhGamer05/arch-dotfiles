...
-- Alt-Tab: cycle to next window and raise it
...
hl.bind(
	mainMod .. " + V",
	hl.dsp.exec_cmd("bash -c 'cliphist list | rofi -dmenu -p \"󰅌 Clipboard\" | cliphist decode | wl-copy'")
)
...
hl.bind(
	...
	hl.dsp.exec_cmd("bash -c '$HOME/.config/hypr/scripts/volume.sh --inc'"),
	{ locked = true, repeating = true }
)
hl.bind(
	"XF86AudioLowerVolume",
	hl.dsp.exec_cmd("bash -c '$HOME/.config/hypr/scripts/volume.sh --dec'"),
	{ locked = true, repeating = true }
)
hl.bind(
	"XF86AudioMute",
	hl.dsp.exec_cmd("bash -c '$HOME/.config/hypr/scripts/volume.sh --toggle'"),
	{ locked = true, repeating = true }
)
hl.bind(
	"XF86AudioMicMute",
	hl.dsp.exec_cmd("bash -c '$HOME/.config/hypr/scripts/volume.sh --toggle-mic'"),
	{ locked = true, repeating = true }
)
hl.bind(
	"XF86MonBrightnessUp",
	hl.dsp.exec_cmd("bash -c '$HOME/.config/hypr/scripts/brightness.sh --inc'"),
	{ locked = true, repeating = true }
)
hl.bind(
	"XF86MonBrightnessDown",
	hl.dsp.exec_cmd("bash -c '$HOME/.config/hypr/scripts/brightness.sh --dec'"),
	{ locked = true, repeating = true }
)
